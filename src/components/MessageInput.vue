...
function send() {
  if (!text.value.trim() || !chat.activeChatId) return
  wsService.send(chat.activeChatId, text.value.trim())
  text.value = ''
}
</script>
...
<template>
  <div class="input-area">
    ...
    <input v-model="text" class="msg-input" placeholder="Start Typing..." @keydown.enter="send" />
